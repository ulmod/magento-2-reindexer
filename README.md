# Magento 2 Reindexer Extension

[Magento 2 Reindexer](https://www.ulmod.com/reindexer-for-magento-2.html)  is a Magento 2 extension that allows store administrators to mass reindex data from the backend at any time.

Note: this Magento 2 Reindexer extension is ideal for small shops, project managers, QA during site development and testing.
For a large productions environment, it's great to re-index from the command-line interface with "bin/magento indexer:reindex"

<a href="https://www.ulmod.com/reindexer-for-magento-2.html"><img width="205" src="https://www.ulmod.com/media/wysiwyg/um-download-now1.png"></a>

## Key Features

* Auto-adds a mass "Reindex Data" action in the backend, allowing store admin to reindex all data with a single click
* Display notification and time about data re-indexed
* Ability to restrict the mass "Reindex Data" by admin role


<img src="https://www.ulmod.com/media/ulmod/product_content/reindexer-p-main.png">
